...
if(!file.exists("normalization_reference.rda")){
    print("Downloading compressed gene expression matrix.")
    url = "https://s3.amazonaws.com/mssm-seq-matrix/normalization_reference.rda"
    download.file(url, "normalization_reference.rda", quiet = FALSE)
}
...
res = load("normalization_reference.rda")
print("normalization reference.rda ready")
